    ...
    public FullName {
        if (value == null || value.isBlank()) {
            throw new IllegalArgumentException(
                    "io.github.phunguy65.zms.usermanagement.domain.model.valueobject.FullName must not be blank");
        }
        if (value.length() > 255) {
            throw new IllegalArgumentException(
                    "io.github.phunguy65.zms.usermanagement.domain.model.valueobject.FullName must not exceed 255 characters");
        }
        value = value.strip();
    }
