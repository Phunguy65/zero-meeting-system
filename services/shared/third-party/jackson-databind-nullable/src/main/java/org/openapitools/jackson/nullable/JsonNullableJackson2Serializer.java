...
public class JsonNullableJackson2Serializer extends ReferenceTypeSerializer<JsonNullable<?>> {
    ...
    protected JsonNullableJackson2Serializer(
    ...
    protected JsonNullableJackson2Serializer(
            JsonNullableJackson2Serializer base,
    ...
    protected ReferenceTypeSerializer<JsonNullable<?>> withResolved(
            ...
            JsonSerializer<?> valueSer,
            NameTransformer unwrapper) {
        return new JsonNullableJackson2Serializer(
                this, prop, vts, valueSer, unwrapper, _suppressableValue);
    }
