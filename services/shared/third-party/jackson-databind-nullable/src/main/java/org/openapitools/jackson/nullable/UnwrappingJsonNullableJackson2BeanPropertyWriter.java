...
public class UnwrappingJsonNullableJackson2BeanPropertyWriter extends UnwrappingBeanPropertyWriter {
    ...
    public UnwrappingJsonNullableJackson2BeanPropertyWriter(
            BeanPropertyWriter base, NameTransformer transformer) {
        super(base, transformer);
    }

    protected UnwrappingJsonNullableJackson2BeanPropertyWriter(
            UnwrappingBeanPropertyWriter base, NameTransformer transformer, SerializedString name) {
        super(base, transformer, name);
    }

    @Override
    protected UnwrappingBeanPropertyWriter _new(
            NameTransformer transformer, SerializedString newName) {
