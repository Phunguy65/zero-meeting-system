...
public class JsonNullableJackson2Deserializer
    ...
    /**********************************************************
     */
    public JsonNullableJackson2Deserializer(
            JavaType fullType,
        ...
        if (fullType instanceof ReferenceType
                && ((ReferenceType) fullType).getReferencedType() != null) {
            this.isStringDeserializer =
                    ((ReferenceType) fullType).getReferencedType().isTypeOrSubTypeOf(String.class);
        }
    }
    ...
    @Override
    public JsonNullable<Object> deserialize(JsonParser p, DeserializationContext ctxt)
            throws IOException {
    ...
    @Override
    public JsonNullableJackson2Deserializer withResolved(
            TypeDeserializer typeDeser, JsonDeserializer<?> valueDeser) {
        return new JsonNullableJackson2Deserializer(
