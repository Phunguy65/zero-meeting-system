...
public class JsonNullableJackson3BeanPropertyWriter extends BeanPropertyWriter {
    ...
    protected JsonNullableJackson3BeanPropertyWriter(
            BeanPropertyWriter base, PropertyName newName) {
        super(base, newName);
    }
    ...
    @Override
    public void serializeAsProperty(Object bean, JsonGenerator jgen, SerializationContext ctxt)
            throws Exception {
