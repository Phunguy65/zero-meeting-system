...
class JsonNullableBasicTest extends ModuleTestBase {
    ...
    private enum TypeReferences {
        ...
        JSON_NULLABLE_GENERIC_DATA {
            ...
            public Object getType(JsonProcessor jsonProcessor) {
                ...
                if (jsonProcessor instanceof Jackson3Processor) {
                    return new tools.jackson.core.type.TypeReference<
                            JsonNullable<JsonNullableGenericData<String>>>() {};
                }
                throw new RuntimeException("jsonProcessor type not implemented");
            }
        },
    ...
    void testDeserAbsent() throws Exception {
        ...
        JsonNullable<?> value = jsonProcessor.readValue("null", type);
    ...
    void testDeserSimpleString() throws Exception {
        Object type = TypeReferences.STRING.getType(jsonProcessor);
        JsonNullable<?> value = jsonProcessor.readValue("\"simpleString\"", type);
    ...
    void testDeserInsideObject() throws Exception {
        JsonNullableData data =
                jsonProcessor.readValue("{\"myString\":\"simpleString\"}", JsonNullableData.class);
    ...
    void testDeserComplexObject() throws Exception {
        ...
        JsonNullable<JsonNullableData> data =
                jsonProcessor.readValue("{\"myString\":\"simpleString\"}", type);
    ...
    void testDeserGeneric() throws Exception {
        ...
        JsonNullable<JsonNullableGenericData<String>> data =
                jsonProcessor.readValue("{\"myData\":\"simpleString\"}", type);
        assertTrue(data.isPresent());
    ...
    void testWithTypingEnabled() throws Exception {
        ...
        final JsonNullableData deserializedMyData =
                jsonProcessor.readValue(json, JsonNullableData.class);
