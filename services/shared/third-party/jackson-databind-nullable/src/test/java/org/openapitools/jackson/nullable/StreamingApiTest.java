...
public class StreamingApiTest {
    ...
    static ReflectiveService<Optional<Optional<String>>> OPTIONAL =
            new ReflectiveService<Optional<Optional<String>>>(Optional.class);
    ...
    public abstract class BaseTest {
        ...
        public void standardCall(
                String name, Callable<JsonNullable<String>> callable, Matcher<Object> matcher) {
        ...
        public Stream<Arguments> args() {
            return baseArgs()
                    .map(args -> new Object[] {
                        args[0], createCall(args), createMatcher(args[args.length - 1])
                    })
        ...
        public void equivalentCall(
                String name,
                Callable<Optional<Optional<String>>> callable,
        ...
        public Stream<Arguments> equivalentArgs() {
            return baseArgs()
                    .map(args -> new Object[] {
                        args[0], createEquivalentCall(args), createMatcher(args[args.length - 1])
                    })
    ...
    public class OrTest extends BaseTest {
        public Stream<Object[]> baseArgs() {
            ...
            return Arrays.asList(new Object[][] {
                        ...
                        {
                            "or value supplied on undefined",
                            UNDEFINED,
                            supplier(JSON_OTHER),
                            JSON_OTHER
                        },
        ...
        public Callable<?> createCall(Object[] row) {
            return biFunctionCall(JsonNullable<String>::or, asJson(row[1]), asSupplier(row[2]));
        }
    ...
    public class OrElseTest extends BaseTest {
        ...
        @Override
        public Callable<?> createCall(Object[] row) {
            return biFunctionCall(JsonNullable<String>::orElse, asJson(row[1]), (String) row[2]);
        }
    ...
    public class OrElseGetTest extends BaseTest {
        ...
        public Callable<?> createCall(Object[] row) {
            return biFunctionCall(
                    JsonNullable<String>::orElseGet, asJson(row[1]), asSupplier(row[2]));
        }
    ...
    public class OrElseThrowTest extends BaseTest {
        ...
        @Override
        public Callable<?> createCall(Object[] row) {
            return functionCall(JsonNullable<String>::orElseThrow, asJson(row[1]));
        }
    ...
    public class OrElseThrowWithSupplierTest extends BaseTest {
        ...
        public Callable<?> createCall(Object[] row) {
            return biFunctionWithThrowsCall(
                    JsonNullable<String>::orElseThrow, asJson(row[1]), asExceptionSupplier(row[2]));
        }
    ...
    public class MapTest extends BaseTest {
        public Stream<Object[]> baseArgs() {
            Function<String, String> MAPPING =
                    value -> value != null ? value + " mapped" : "null mapped";
        ...
        public Callable<?> createCall(Object[] row) {
            return biFunctionCall(
                    JsonNullable<String>::map, asJson(row[1]), (Function<String, String>) row[2]);
        }
    ...
    public class FilterTest extends BaseTest {
        ...
        public Callable<?> createCall(Object[] row) {
            return biFunctionCall(
                    JsonNullable<String>::filter, asJson(row[1]), (Predicate<String>) row[2]);
        }
    ...
    public class FlatMapTest extends BaseTest {
        public Stream<Object[]> baseArgs() {
            ...
            Function<String, JsonNullable<String>> NULL_TO_UNDEFINED =
                    value -> value != null ? of(value) : UNDEFINED;
            ...
            return Arrays.asList(new Object[][] {
                        {
                            "flatMap any to undefined on value",
                            JSON_VALUE,
                            ANY_TO_UNDEFINED,
                            UNDEFINED
                        },
                        ...
                        {
                            "flatMap any to undefined on undefined",
                            UNDEFINED,
                            ANY_TO_UNDEFINED,
                            UNDEFINED
                        },
                        {
                            "flatMap null to undefined on value",
                            JSON_VALUE,
                            NULL_TO_UNDEFINED,
                            JSON_VALUE
                        },
                        {
                            "flatMap null to undefined on null",
                            JSON_NULL,
                            NULL_TO_UNDEFINED,
                            UNDEFINED
                        },
                        {
                            "flatMap null to undefined on undefined",
                            UNDEFINED,
                            NULL_TO_UNDEFINED,
                            UNDEFINED
                        },
        ...
        public Stream<Arguments> args() {
            return baseArgs()
                    .map(args -> new Object[] {
                        args[0],
                        biFunctionCall(JsonNullable<String>::flatMap, asJson(args[1]), (Function<
                                        String, JsonNullable<String>>)
                                args[2]),
                        createMatcher(args[3])
                    })
                    .map(args -> Arguments.argumentSet((String) args[0], args));
        }
        ...
        @Override
        public Callable<?> createCall(Object[] row) {
            return biFunctionCall(JsonNullable<String>::flatMap, asJson(row[1]), (Function<
                            String, JsonNullable<String>>)
                    row[2]);
        }
        ...
        public Callable<?> createEquivalentCall(Object[] row) {
            return biFunctionCall(
                    OPTIONAL.forName("flatMap")
                            .<Function<Optional<String>, Optional<Optional<String>>>>argument(
                                    Function.class)
                            .<Optional<Optional<String>>>getBiFunction()
                            .map(f -> f.andThen(StreamingApiTest::optionalToNullable))
                            .orElse(null),
                    ...
                    Optional.ofNullable(asFunction(row[2]))
                            .map(f -> f.compose(StreamingApiTest::optionalValueToNullableValue)
    ...
    public class IsUndefinedTest extends BaseTest {
        ...
        @Override
        public Callable<?> createCall(Object[] row) {
            return functionCall(JsonNullable<String>::isUndefined, asJson(row[1]));
        }

        @Override
        public Callable<?> createEquivalentCall(Object[] row) {
            return functionCall(
                    OPTIONAL.forName("isEmpty").<Boolean>getFunction().orElse(null),
                    nullableToOptional(row[1]));
        }
    }
        ...
        public Callable<?> createEquivalentCall(Object[] row) {
            return functionCall(
                    OPTIONAL.forName("stream")
                            ...
                            .map(f -> f.andThen(s ->
                                            s.map(StreamingApiTest::optionalValueToNullableValue))
                                    .andThen(s -> s.collect(Collectors.toList())))
                            .orElse(null),
                    nullableToOptional(row[1]));
        }
    ...
    public class IfPresentOrElseTest {
        ...
        public Stream<Object[]> baseArgs() {
            ...
            Function<String, BiConsumer<TestConsumer<String>, Runnable>> ACTION_CALLED =
                    (value) -> (c, r) -> {
                        verify(c).accept(value);
                    };
            BiConsumer<TestConsumer<String>, Runnable> UNDEFINED_ACTION_CALLED = (c, r) -> {
                verify(r).run();
            };
            BiConsumer<TestConsumer<String>, Runnable> NOTHING_CALLED = (c, r) -> {};
            return Arrays.asList(new Object[][] {
                        {
                            "ifPresentOrElse on value with action and undefined action",
                            JSON_VALUE,
                            ACTION,
                            UNDEFINED_ACTION,
                            null,
                            ACTION_CALLED.apply(VALUE)
                        },
                        {
                            "ifPresentOrElse on null with action and undefined action",
                            JSON_NULL,
                            ACTION,
                            UNDEFINED_ACTION,
                            null,
                            ACTION_CALLED.apply(NULL)
                        },
                        {
                            "ifPresentOrElse on undefined with action and undefined action",
                            UNDEFINED,
                            ACTION,
                            UNDEFINED_ACTION,
                            null,
                            UNDEFINED_ACTION_CALLED
                        },
                        {
                            "ifPresentOrElse on value with null action and undefined action",
                            JSON_VALUE,
                            NULL_ACTION,
                            UNDEFINED_ACTION,
                            NPE,
                        ...
                        {
                            "ifPresentOrElse on null with null action and undefined action",
                            JSON_NULL,
                            NULL_ACTION,
                            UNDEFINED_ACTION,
                            NPE,
                        ...
                        {
                            "ifPresentOrElse on undefined with null action and undefined action",
                            UNDEFINED,
                            NULL_ACTION,
                            UNDEFINED_ACTION,
                            null,
                        ...
                        {
                            "ifPresentOrElse on value with action and null undefined action",
                            JSON_VALUE,
                            ACTION,
                            NULL_UNDEFINED_ACTION,
                            null,
                            ACTION_CALLED.apply(VALUE)
                        },
                        {
                            "ifPresentOrElse on null with action and null undefined action",
                            JSON_NULL,
                            ACTION,
                            NULL_UNDEFINED_ACTION,
                            null,
                        ...
                        {
                            "ifPresentOrElse on undefined with action and null undefined action",
                            UNDEFINED,
                            ACTION,
                            NULL_UNDEFINED_ACTION,
                            NPE,
                        ...
                        {
                            "ifPresentOrElse on value with null action and null undefined action",
                            JSON_VALUE,
                            NULL_ACTION,
                            NULL_UNDEFINED_ACTION,
                            NPE,
                        ...
                        {
                            "ifPresentOrElse on null with null action and null undefined action",
                            JSON_NULL,
                            NULL_ACTION,
                            NULL_UNDEFINED_ACTION,
                            NPE,
                        ...
                        {
                            "ifPresentOrElse on undefined null with action and null undefined action",
                            UNDEFINED,
                            NULL_ACTION,
                            NULL_UNDEFINED_ACTION,
                            NPE,
            ...
            return baseArgs()
                    .map(args -> new Object[] {
                        ...
                        args[2] != null
                                ? mock(
                                        TestConsumer.class,
                                        AdditionalAnswers.delegatesTo((asConsumer(args[2]))))
                                : null,
                        args[3] != null
                                ? mock(Runnable.class, AdditionalAnswers.delegatesTo((Runnable)
                                        args[3]))
                                : null,
                        args[4],
                        args[5]
                    ...
                    .map(args -> new Object[] {
                        args[0],
                        triConsumerCall(
                                JsonNullable<String>::ifPresentOrElse,
                                asJson(args[1]),
                                asConsumer(args[2]),
                                (Runnable) args[3]),
                        ...
                        new Runnable() {
                            public void run() {
                                asBiConsumer(args[5])
                                        .accept(asConsumer(args[2]), (Runnable) args[3]);
            ...
            return baseArgs()
                    ...
                    .map(args -> new Object[] {
                        ...
                        triConsumerCall(
                                ...
                                (TestConsumer<Optional<String>>) (value) -> (asConsumer(args[2]))
                                        .accept(optionalValueToNullableValue(value)),
                                (Runnable) args[3]),
                        createMatcher(args[4]),
                        new Runnable() {
                            public void run() {
        ...
        public void standardCall(
                String name,
                Callable<JsonNullable<String>> callable,
                Matcher<Object> matcher,
                Runnable verify) {
            Assumptions.assumeTrue(callable != null);
            Object actual = null;
    ...
    public static TestPredicate<Optional<String>> nullableValueToOptionalValue(
            TestPredicate<String> test) {
        if (test == null) return null;
        return test.compose(StreamingApiTest::optionalValueToNullableValue);
    }

    public static Function<Optional<String>, Optional<String>> nullableValueToOptionalValue(
            Function<String, String> f) {
        if (f == null) return null;
        return f.compose(StreamingApiTest::optionalValueToNullableValue)
                .andThen(StreamingApiTest::nullableValueToOptionalValue);
    }

    public Supplier<Optional<Optional<String>>> nullableSupplierToOptionalSupplier(
            Supplier<JsonNullable<String>> supplier) {
    ...
    public static Supplier<Optional<String>> nullableValueSupplierToOptionalValueSupplier(
    ...
    public static class ReflectiveService<T> {
        ...
        public class NoArguments {
            ...
            public <R> Optional<Function<T, R>> getFunction() {
                return getMethod(methodName).map(method -> {
                    return optional -> {
                        try {
            ...
            public class OneArgument<A> {
                ...
                public <E extends Exception> OneArgumentWithThrows<A, E> throwing(
                        Class<E> thrownType) {
                ...
                public <R> Optional<BiFunction<T, A, R>> getBiFunction() {
                    return getMethod(methodName, firstType).map(method -> {
            ...
            public class TwoArguments<A1, A2> {
                ...
                public Optional<TriConsumer<T, A1, A2>> getTriConsumer() {
                    return getMethod(methodName, firstType, secondType).map(method -> {
    ...
    public static <A, B, R, X extends Throwable> Callable<R> biFunctionWithThrowsCall(
            BiFunctionWithThrows<A, B, R, X> f, A a, B b) {
        if (f == null) return null;
        return () -> {
            try {
                return f.apply((A) a, (B) b);
    ...
    public static interface BiFunctionWithThrows<T, U, R, X extends Throwable> {
        ...
        public default <W> BiFunctionWithThrows<T, U, W, X> andThen(
                Function<? super R, ? extends W> f) {
            return (T t, U u) -> {
