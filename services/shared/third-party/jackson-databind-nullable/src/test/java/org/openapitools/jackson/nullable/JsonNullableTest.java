...
class JsonNullableTest extends ModuleTestBase {
    ...
    public static class TestBean {
        ...
        public boolean equals(Object obj) {
            ...
            return castObj.foo == foo && (castObj.bar != null && castObj.bar.equals(bar));
        }
    ...
    void testStringAbsent() throws Exception {
        assertNull(roundtrip(JsonNullable.<String>undefined(), jsonNullableStringType)
                .get());
    }
    ...
    void testStringNull() throws Exception {
        assertNull(
                roundtrip(JsonNullable.<String>of(null), jsonNullableStringType).get());
    }
    ...
    void testStringPresent() throws Exception {
        assertEquals(
                "test",
                roundtrip(JsonNullable.of("test"), jsonNullableStringType).get());
    }

    @Test
    void testBeanAdsent() throws Exception {
        assertNull(roundtrip(JsonNullable.<TestBean>undefined(), jsonNullableBeanType)
                .get());
    }
    ...
    void testBeanNull() throws Exception {
        assertNull(
                roundtrip(JsonNullable.<TestBean>of(null), jsonNullableBeanType).get());
    }
    ...
    void testBeanPresent() throws Exception {
        ...
        assertEquals(
                bean, roundtrip(JsonNullable.of(bean), jsonNullableBeanType).get());
    }
    ...
    void testJsonNullableStringInBean() throws Exception {
        JsonNullableStringBean bean =
                jsonProcessor.readValue("{\"value\":\"xyz\"}", JsonNullableStringBean.class);
    ...
    void testWithCustomDeserializer() throws Exception {
        JsonProcessor.CaseChangingStringWrapper w = jsonProcessor.readValue(
                aposToQuotes("{'value':'FoobaR'}"),
    ...
    void testCustomSerializer() throws Exception {
        ...
        String json =
                jsonProcessor.writeValueAsString(jsonProcessor.getCaseChangingStringWrapper(VALUE));
    ...
    void testCustomSerializerIfJsonNullableAbsent() throws Exception {
        ...
        assertEquals(
                aposToQuotes("{'value':'FOO'}"),
                jsonProcessor.writeValueAsString(
                        jsonProcessor.getCaseChangingStringWrapper("foo")));
        // absent is not strictly null so
        assertEquals(
                aposToQuotes("{'value':null}"),
