...
function MicOnIcon({ small = false }: { small?: boolean }) {
  ...
  return (
    <svg aria-hidden="true" className={cls} fill="currentColor" viewBox="0 0 24 24">
...
const PARTICIPANTS: Participant[] = [
  {
    ...
    isSpeaking: false,
    tileBg:
      "bg-[linear-gradient(160deg,_#1a2c4a_0%,_#2b4068_50%,_#1e3558_100%)]",
  ...
  },
  {
    ...
    isSpeaking: false,
    tileBg:
      "bg-[linear-gradient(160deg,_#1c2433_0%,_#2a3547_50%,_#1a2233_100%)]",
  ...
  },
  {
    ...
    isSpeaking: false,
    tileBg:
      "bg-[linear-gradient(160deg,_#1a1f2e_0%,_#252d42_50%,_#1a1f2e_100%)]",
  ...
  },
  {
    ...
    isSpeaking: true,
    tileBg:
      "bg-[linear-gradient(160deg,_#1e2d3a_0%,_#2d4455_50%,_#1e2d3a_100%)]",
            ...
            {PARTICIPANTS.map((p) => (
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 flex items-center gap-2 rounded-xl bg-black/55 px-3 py-1.5 backdrop-blur-sm">
                  <span className={p.micOn ? "text-white/90" : "text-red-400"}>
                    {p.micOn ? <MicOnIcon small /> : <MicOffIcon small />}
                  </span>
        ...
        <aside className="flex w-[300px] shrink-0 flex-col border-l border-[#e5eaf2] bg-white xl:w-[340px]">
          ...
          <div className="shrink-0 border-b border-[#e5eaf2] px-6 py-5">
            ...
            <p className="mt-1 text-[0.95rem] text-[#475467]">
              {t("activeSession")} • {PARTICIPANTS.length} {t("participants")}
            </p>
          </div>
                    ...
                    <div className="mb-2 flex items-center justify-between gap-3">
                      <span
                        className={`text-[1.02rem] font-semibold ${
                          msg.isYou ? "text-[#1a73e8]" : "text-[#15191f]"
                        }`}
                      >
            ...
            <div className="flex-1 space-y-3 overflow-y-auto p-5">
              {PARTICIPANTS.map((p) => (
                ...
                >
                  ...
                  <span className={p.micOn ? "text-[#1a73e8]" : "text-[#d1d5db]"}>
                    {p.micOn ? <MicOnIcon small /> : <MicOffIcon small />}
                  </span>
                </div>
              ))}
