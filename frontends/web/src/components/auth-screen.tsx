                            ...
                            <div className='mx-auto flex h-full w-full max-w-[560px] flex-col'>
                                ...
                                >
                                    ...
                                    <label className='flex flex-col gap-3'>
                                        ...
                                        <input
                                            ref={emailRef}
                                            className={`h-16 rounded-full bg-[#f1f3f7] px-6 text-xl text-[#111827] outline-none ring-1 transition focus:ring-2 focus:ring-[#1a73e8] ${
                                                fieldErrors.email
                                                    ? 'ring-red-400'
                                                    : 'ring-transparent'
                                            }`}
                                    ...
                                    <label className='flex flex-col gap-3'>
                                        ...
                                        <div
                                            className={`flex h-16 items-center rounded-full bg-[#f1f3f7] pr-5 ring-1 transition focus-within:ring-2 focus-within:ring-[#1a73e8] ${
                                ...
                                <div className='mt-9'>
                                    ...
                                    <button
                                        className='mt-9 flex h-16 w-full items-center justify-center gap-4 rounded-full border border-[#dbe2ee] bg-white px-6 text-[1.15rem] font-medium text-[#111827] transition-colors hover:bg-[#f8fbff] disabled:opacity-60'
                                        disabled={isSubmitting}
