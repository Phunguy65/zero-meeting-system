                    ...
                    <article className='rounded-[2rem] bg-white p-8 shadow-[0_26px_70px_-38px_rgba(15,23,42,0.2)] sm:p-10'>
                        ...
                        >
                            ...
                            <div className='block'>
                                ...
                                <div className='mt-4 flex h-16 items-center rounded-[1.2rem] bg-[#f2f4f7] px-6'>
                                    <select className='w-full appearance-none bg-transparent text-xl text-[#111827] outline-none'>
                                        <option value='15'>
                                            {t('duration15')}
                                        </option>
                                        <option value='30'>
