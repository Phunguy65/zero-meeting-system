...
import com.example.zeromeeting.view.auth.login.LoginActivity; // Import màn login để quay về
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void setupListeners() {
        // Xử lý các nút Menu
        btnAccountSettings.setOnClickListener(v -> Toast.makeText(this, "Mở Cài đặt tài khoản", Toast.LENGTH_SHORT).show());
        btnMeetingHistory.setOnClickListener(v -> Toast.makeText(this, "Mở Lịch sử cuộc họp", Toast.LENGTH_SHORT).show());
        btnHelpSupport.setOnClickListener(v -> Toast.makeText(this, "Mở Trợ giúp", Toast.LENGTH_SHORT).show());
