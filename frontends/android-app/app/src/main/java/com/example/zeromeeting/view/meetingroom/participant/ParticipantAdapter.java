...
import io.github.phunguy65.zms.frontends.R; // Nhớ import R của bạn
...
public class ParticipantAdapter extends RecyclerView.Adapter<ParticipantAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (p.isMicOn()) {
            ...
            holder.btnMic.setBackgroundTintList(android.content.res.ColorStateList.valueOf(Color.parseColor("#FFF0F0"))); // Nền hồng nhạt
        }
        ...
        if (p.isVideoOn()) {
            ...
            holder.btnCamera.setBackgroundTintList(android.content.res.ColorStateList.valueOf(Color.parseColor("#F5F5F5")));
        }
    }
