...
public class MeetingRoomActivity extends AppCompatActivity {
    ...
    private void setupListeners() {
        ...
        btnFloatMic.setOnClickListener(v -> {
            isMicOn = !isMicOn;
            if (isMicOn) {
                btnFloatMic.setBackgroundTintList(getResources().getColorStateList(android.R.color.holo_blue_light)); // Giả lập màu xanh
                Toast.makeText(this, "Microphone On", Toast.LENGTH_SHORT).show();
            } else {
                btnFloatMic.setBackgroundTintList(getResources().getColorStateList(android.R.color.darker_gray));
