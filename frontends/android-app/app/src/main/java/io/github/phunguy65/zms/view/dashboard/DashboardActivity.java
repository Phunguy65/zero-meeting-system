package io.github.phunguy65.zms.view.dashboard;
...
import io.github.phunguy65.zms.view.calendar.CalendarActivity;
import io.github.phunguy65.zms.view.meetingcreate.CreateMeetingActivity;
import io.github.phunguy65.zms.view.profile.ProfileActivity;
import io.github.phunguy65.zms.view.schedule.ScheduleActivity;
...
public class DashboardActivity extends AppCompatActivity {
    ...
    private void setupListeners() {
        ...
        cardJoinMeeting.setOnClickListener(v -> {
            Toast.makeText(this, "Mở màn hình Vào phòng họp nhanh", Toast.LENGTH_SHORT)
                    .show();
            startActivity(new Intent(DashboardActivity.this, CreateMeetingActivity.class));
            finish();
        });
