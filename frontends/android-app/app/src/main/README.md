...
Ứng dụng Android cho hệ thống **Zero Meeting System**. Module này chịu trách
nhiệm:
...
Ứng dụng được xây dựng theo mô hình **MVVM + Dependency Injection** để đảm bảo
code rõ ràng, dễ mở rộng và dễ bảo trì.
...
**View (Activity / Fragment)** Hiển thị giao diện và nhận sự kiện từ người dùng.

**ViewModel** Xử lý logic của UI và quản lý trạng thái màn hình.

**Repository** Lớp trung gian giữa ViewModel và API.

**Network Layer** Định nghĩa API và cấu hình Retrofit.
